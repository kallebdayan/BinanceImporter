...
class CandleCollector:
    ...
    def collect_single_symbol(self, symbol: str, interval: str, 
        ...
        try:
            ...
            if not start_time:
                ...
                """
                result = self.db.execute_query(query, (symbol, interval), fetch=True)
                last_time = result[0]['last_collected_time'] if result else None
                if last_time:
    ...
    def collect_all_tokens_single(self, interval: str = '1h', limit: int = 100):
        ...
        for token in tokens:
            ...
            symbol = token['symbol']
            collected, status = self.collect_single_symbol(symbol, interval, limit=limit)
    ...
    def worker_thread(self):
        ...
        while not self.stop_event.is_set():
            try:
                ...
                self.collect_single_symbol(symbol, interval, limit=100)
